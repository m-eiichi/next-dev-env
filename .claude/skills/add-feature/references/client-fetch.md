...
使うかどうかと書き方は `docs/02_共通設計/04_データ取得・更新.md` の「5. クライアントでの取得（TanStack Query）」、エラーの形は `docs/02_共通設計/09_外部公開API.md` の「6」の「失敗したとき」。見本は `docs/03_画面設計/SCR-011_サンプル検索.md` とそのコード。
